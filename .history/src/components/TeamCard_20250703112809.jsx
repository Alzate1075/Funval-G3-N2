...
export function TeamCard(props) {
  return (
    <div className={`${props.extraClass}`}>
      <div className="text-black md:text-white md:flex md:items-center md:justify-center gap-6 relative mx-6">
        <img src={props.image} alt={props.name} className="md:w-[200px] w-25" />
        <span className="absolute rotate-90 text-[10px] top-1 md:text-[14px] md:ml-60">
          {props.role}
        </span>
      </div>
