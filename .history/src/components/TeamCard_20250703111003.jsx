  ...
  return (
    <div className={`${props.extraClass}`}>
      <div className="text-black md:text-white md:flex md:items-center md:justify-center gap-2 relative">
        ...
        <span className="absolute right-0 top-1/2 -translate-y-1/2 rotate-90 origin-left text-[10px] md:text-[13px]">
          {props.role}
        </span>
      </div>
      <div className="md:text-white text-center mt-2 flex justify-star pl-4">
