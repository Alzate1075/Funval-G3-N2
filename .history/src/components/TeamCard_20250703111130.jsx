...
export function TeamCard(props) {
  return (
    <div className={`${props.extraClass}`}>
      <div className="text-black md:text-white md:flex gap-2 relative">
        <img src={props.image} alt={props.name} className="md:w-[200px] w-20" />
        <span className="absolute right-0 top-1/2 -translate-y-end rotate-90 origin-left text-[10px] md:text-[13px]">
          {props.role}
        </span>
      </div>
